...
* __zq__ : 윈도우를 모니터 왼쪽 위로 이동시킵니다. 숫자 조합 가능하며, 숫자와 조합할 경우 해당 모니터의 왼쪽 위로 이동시킵니다. 

zq : primary 모니터의 왼쪽 위로 이동. (일반적으로 1zq 와 같음)

1zq : 1번 모니터의 왼쪽 위로 이동.

2zq : 2번 모니터의 왼쪽 위로 이동.

10zq : 10번 모니터의 왼쪽 위로 이동.
